...
def initialise_default_params(calc_name):
    ...
    params = {
        ...
        "final_refine": {"value": "",
                   "specified": False,
                   "type": "boolean",
                   "description": "If True perform final fine VASP calculations for best structure. Default: False",
                   },
        "vasp_final_settings": {"value": "",
                          "specified": False,
                          "type": "dictionary",
                          "description": 'Settings for final fine VASP calculation. Default: None.',
                      },
